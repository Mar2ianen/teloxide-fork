...
# Broaden getUpdates.offset so every UpdateId can be advanced without wrapping.
...
fn maximum_update_id_serializes_as_a_positive_next_offset() {
    ...
    assert_eq!(value["offset"], 4_294_967_296_i64);
}
''')

# Generate the widened payload and all setter/adaptor surfaces. The second pass
# must be clean and succeed.
