...
define_message_ext! {
    ...
    (filter_suggested_post_approved, Message::suggested_post_approved),
    (filter_suggested_post_approval_failed, Message::suggested_post_approval_failed),
...
define_update_ext! {
    ...
    (
        filter_stopped_message_generation,
