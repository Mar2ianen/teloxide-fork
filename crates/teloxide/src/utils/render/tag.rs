...
// There is no Cashtag or Hashtag because we can't influence them in any way,
// they are autogenerated by the TBA. There is no point in parsing them, they
// are neither Markup nor HTML
